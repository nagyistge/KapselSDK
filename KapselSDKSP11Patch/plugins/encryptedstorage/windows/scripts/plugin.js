...
module.exports = function (ctx) {
    ...
    */
    plugin.foldersToCopy = [
        //windows81 - win
        {
            "plugins/kapsel-plugin-encryptedstorage/windows/windows81/win/x64/":
              "platforms/windows/plugins/kapsel-plugin-encryptedstorage/windows81/win/x64"
        },
        {
            "plugins/kapsel-plugin-encryptedstorage/windows/windows81/win/x86/":
              "platforms/windows/plugins/kapsel-plugin-encryptedstorage/windows81/win/x86"
        },
        //windows81 - wp
        {
            "plugins/kapsel-plugin-encryptedstorage/windows/windows81/wp/ARM/":
              "platforms/windows/plugins/kapsel-plugin-encryptedstorage/windows81/wp/ARM"
        },
        {
            "plugins/kapsel-plugin-encryptedstorage/windows/windows81/wp/x86/":
              "platforms/windows/plugins/kapsel-plugin-encryptedstorage/windows81/wp/x86"
        },
        //windows10
        {
            "plugins/kapsel-plugin-encryptedstorage/windows/windows10/x64/":
              "platforms/windows/plugins/kapsel-plugin-encryptedstorage/windows10/x64"
        },
        {
            "plugins/kapsel-plugin-encryptedstorage/windows/windows10/x86/":
              "platforms/windows/plugins/kapsel-plugin-encryptedstorage/windows10/x86"
        },
        {
            "plugins/kapsel-plugin-encryptedstorage/windows/windows10/ARM/":
              "platforms/windows/plugins/kapsel-plugin-encryptedstorage/windows10/ARM"
        }
    ];

    // Folders to remove during uninstall
    plugin.foldersToRemove = [
        path.join(plugin.rootdir, "platforms/windows/plugins/kapsel-plugin-encryptedstorage")
    ];
