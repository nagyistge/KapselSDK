...
/*
    ...
    These hook are required because Cordova currently does not support adding references to dependencies different for Windows 8.1 and 10.s
...
module.exports = function (ctx) {
    ...
    plugin.filesToCopy = [
        "SAP.VoiceRecording.winmd"
    ];

    // Aadd reference to these files in the .jsporj
    ...
    */
    plugin.foldersToCopy = [
        //windows81
        {
            "plugins/kapsel-plugin-voicerecording/windows/windows81/bin/":
              "platforms/windows/plugins/kapsel-plugin-voicerecording/windows81"
        },
        //windows10
        {
            "plugins/kapsel-plugin-voicerecording/windows/windows10/bin/":
              "platforms/windows/plugins/kapsel-plugin-voicerecording/windows10"
        }
    ];

    // Folders to remove during uninstall
    plugin.foldersToRemove = [
        path.join(plugin.rootdir, "platforms/windows/plugins/kapsel-plugin-voicerecording")
    ];
