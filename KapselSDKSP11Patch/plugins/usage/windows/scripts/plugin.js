...
module.exports = function (ctx) {
    ...
    */
    plugin.foldersToCopy = [
        //windows81
        {
            "plugins/kapsel-plugin-usage/windows/windows81/bin/":
              "platforms/windows/plugins/kapsel-plugin-usage/windows81"
        },
        //windows10
        {
            "plugins/kapsel-plugin-usage/windows/windows10/bin/":
              "platforms/windows/plugins/kapsel-plugin-usage/windows10"
        }
    ];

    // Folders to remove during uninstall
    plugin.foldersToRemove = [
        path.join(plugin.rootdir, "platforms/windows/plugins/kapsel-plugin-usage")
    ];
